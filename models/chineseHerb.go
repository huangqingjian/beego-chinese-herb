...
// 自定义函数验证
func (u *ChineseHerb) Valid(v * validation.Validation) {

}

// 自定义表名
func (u *ChineseHerb) TableName() string {
	return "tbl_chinese_herb"
}

// 插入中药
func AddChineseHerb(herb ChineseHerb) (int64, error) {
	o := orm.NewOrm()
	id, err := o.Insert(&herb)
	if err != nil {
		return 0, err
	}
	return id, nil
...
// 更新中药
func UpdateChineseHerb(herb ChineseHerb) (int64, error) {
	o := orm.NewOrm()
	count, err := o.Update(&herb)
	if err != nil {
		return 0, err
	}
	return count, err
...
// 删除中药
func DeleteChineseHerb(herb ChineseHerb) (int64, error) {
	o := orm.NewOrm()
	herb.Deleted = 1
	count, err := o.Update(&herb, "deleted")
	if err != nil {
		return 0, err
	}
	return count, err
